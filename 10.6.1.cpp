...
int main()
{
    ...
    while(m>0)
    {
        ...
        // means we are trying to calculare the differnce between the last two
        // something something accordingly for it
        // then what we need to find out accordingly
        // if that differnce makes the last to be negative then i think we are done with
        //it
